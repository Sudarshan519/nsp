...
import '../core/database/local_database_provider.dart' as _i205;
...
import '../features/ads/domain/use_case/get_ads.dart' as _i135;
import '../features/ads/presentation/get_ads/ads_bloc.dart' as _i190;
...
import '../features/auth/presentation/sign_in_form/sign_in_form_bloc.dart'
    as _i183;
import '../features/auth/presentation/sign_up/sign_up_form_bloc.dart' as _i184;
...
import '../features/home/domain/usecases/get_home_page_data.dart' as _i141;
...
import '../features/news/domain/usecase/get_favourite_news.dart' as _i140;
import '../features/news/domain/usecase/get_latest_news.dart' as _i144;
import '../features/news/domain/usecase/get_news_for_you.dart' as _i148;
import '../features/news/domain/usecase/get_news_genre.dart' as _i149;
import '../features/news/domain/usecase/get_news_preferences.dart' as _i150;
...
import '../features/news/presentation/latest_news/latest_news_bloc.dart'
    as _i162;
import '../features/news/presentation/news_for_you/news_bloc.dart' as _i165;
import '../features/news/presentation/news_genre/news_genre_bloc.dart' as _i166;
...
import '../features/resume/domain/usecases/get_downloadable_pdf_link.dart'
    as _i139;
import '../features/resume/domain/usecases/get_resume.dart' as _i153;
...
import '../features/search/domain/usecases/get_search_page_data.dart' as _i154;
import '../features/search/presentation/bloc/search_bloc.dart' as _i182;
...
import '../features/transaction/domain/usecase/get_individual_transaction.dart'
    as _i142;
import '../features/transaction/domain/usecase/get_transaction.dart' as _i156;
...
import 'injectable/data_connection_checker_injectable_module.dart' as _i210;
import 'injectable/flutter_secure_storage_module.dart' as _i208;
import 'injectable/google_login_injectable_module.dart' as _i209;
import 'injectable/http_client_injectable_module.dart' as _i207;
import 'injectable/shared_preference_module.dart'
    as _i211; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i132.DeleteResumeData>(() => _i132.DeleteResumeData(
      repository: get<_i82.ResumeRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i133.EnquireKhanepani>(() => _i133.EnquireKhanepani(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i110.UtilityPaymentRepository>()));
  gh.lazySingleton<_i134.EnquiryNea>(() => _i134.EnquiryNea(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i110.UtilityPaymentRepository>()));
  gh.lazySingleton<_i135.GetAds>(() => _i135.GetAds(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i125.AdsRepository>()));
  gh.factory<_i136.GetAlertPlacesBloc>(
      () => _i136.GetAlertPlacesBloc(get<_i43.GetAlertsPlaces>()));
  gh.lazySingleton<_i137.GetCountries>(() => _i137.GetCountries(
      repository: get<_i66.LocationInformationRepositoryProtocol>()));
  gh.factory<_i138.GetDisasterDetailBloc>(() => _i138.GetDisasterDetailBloc(
      getEarthquakes: get<_i48.GetEarthquakes>(),
      getVolcanoes: get<_i53.GetVolcanoes>()));
  gh.factory<_i139.GetDownloadablePdfLink>(() => _i139.GetDownloadablePdfLink(
      repository: get<_i82.ResumeRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i140.GetFavouriteNews>(() =>
      _i140.GetFavouriteNews(repository: get<_i71.NewsRepositoryProtocol>()));
  gh.lazySingleton<_i141.GetHomePageData>(() => _i141.GetHomePageData(
      repository: get<_i59.HomeReporisitory>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i142.GetIndivisualTransaction>(() =>
      _i142.GetIndivisualTransaction(
          repository: get<_i99.TransactionRepository>(),
          networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i143.GetKhanepaniOffices>(() => _i143.GetKhanepaniOffices(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i110.UtilityPaymentRepository>()));
  gh.lazySingleton<_i144.GetLatestNews>(() => _i144.GetLatestNews(
      repository: get<_i71.NewsRepositoryProtocol>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i145.GetListOfCityFromPrefectures>(() =>
      _i145.GetListOfCityFromPrefectures(
          repository: get<_i66.LocationInformationRepositoryProtocol>()));
  gh.lazySingleton<_i146.GetListOfPaymentMethods>(() =>
      _i146.GetListOfPaymentMethods(
          networkInfo: get<_i14.NetworkInfo>(),
          repository: get<_i63.LoadBalanceRepositories>()));
  gh.lazySingleton<_i147.GetNeaOffice>(() => _i147.GetNeaOffice(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i110.UtilityPaymentRepository>()));
  gh.lazySingleton<_i148.GetNewsForYou>(() => _i148.GetNewsForYou(
      repository: get<_i71.NewsRepositoryProtocol>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i149.GetNewsGenre>(
      () => _i149.GetNewsGenre(repository: get<_i71.NewsRepositoryProtocol>()));
  gh.lazySingleton<_i150.GetNewsPreferences>(() =>
      _i150.GetNewsPreferences(repository: get<_i71.NewsRepositoryProtocol>()));
  gh.factory<_i151.GetPaymentMethodsBloc>(() => _i151.GetPaymentMethodsBloc(
      getListOfPaymentMethods: get<_i146.GetListOfPaymentMethods>(),
      deletecard: get<_i130.DeleteCard>()));
  gh.lazySingleton<_i152.GetPrefectureCityFromPostalCode>(() =>
      _i152.GetPrefectureCityFromPostalCode(
          repository: get<_i66.LocationInformationRepositoryProtocol>()));
  gh.factory<_i153.GetResume>(() => _i153.GetResume(
      repository: get<_i82.ResumeRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i154.GetSearchPageData>(() => _i154.GetSearchPageData(
      repository: get<_i86.SearchRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i155.GetSubscriptionDetailForPartnerService>(() =>
      _i155.GetSubscriptionDetailForPartnerService(
          networkInfo: get<_i14.NetworkInfo>(),
          repository: get<_i110.UtilityPaymentRepository>()));
  gh.lazySingleton<_i156.GetTransactions>(() => _i156.GetTransactions(
      repository: get<_i99.TransactionRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i157.HomePageDataBloc>(() =>
      _i157.HomePageDataBloc(getHomePageData: get<_i141.GetHomePageData>()));
  gh.factory<_i158.IndividualTransactionBloc>(() =>
      _i158.IndividualTransactionBloc(
          getIndividualTxn: get<_i142.GetIndivisualTransaction>()));
  gh.lazySingleton<_i159.JapaneseMannerRepository>(() =>
      _i160.JapaneseMannerRepositoryImpl(
          remoteDataSource: get<_i61.JapaneseMannersRemoteDataSource>(),
          logger: get<_i12.Logger>()));
  gh.factory<_i161.KhanepaniOfficesBloc>(
      () => _i161.KhanepaniOfficesBloc(get<_i143.GetKhanepaniOffices>()));
  gh.lazySingleton<_i162.LatestNewsBloc>(
      () => _i162.LatestNewsBloc(getNews: get<_i144.GetLatestNews>()));
  gh.factory<_i163.LocationViaPostalCodeBloc>(() =>
      _i163.LocationViaPostalCodeBloc(
          getPrefectureCityFromPostalCode:
              get<_i152.GetPrefectureCityFromPostalCode>()));
  gh.factory<_i164.NeaOfficesBloc>(
      () => _i164.NeaOfficesBloc(get<_i147.GetNeaOffice>()));
  gh.lazySingleton<_i165.NewsBloc>(
      () => _i165.NewsBloc(getNews: get<_i148.GetNewsForYou>()));
  gh.factory<_i166.NewsGenreBloc>(
      () => _i166.NewsGenreBloc(getNewsGenre: get<_i149.GetNewsGenre>()));
  gh.factory<_i167.NewsPreferenceBloc>(() => _i167.NewsPreferenceBloc(
      getNewsPreferences: get<_i150.GetNewsPreferences>()));
  gh.lazySingleton<_i168.NotificationRepository>(() =>
      _i169.NotificationRepositoryImpl(
          dataSource: get<_i73.NotificationsRemoteDataSource>(),
          logger: get<_i12.Logger>()));
  gh.factory<_i170.ParnterServicesBloc>(() => _i170.ParnterServicesBloc(
      getPartnerServices: get<_i171.GetPartnerServices>()));
  gh.factory<_i172.PartnerServiceCategoriesBloc>(() =>
      _i172.PartnerServiceCategoriesBloc(
          getPartnerServicesCategories:
              get<_i173.GetPartnerServicesCategories>()));
  gh.factory<_i174.PasswordResetBloc>(() => _i174.PasswordResetBloc(
      resetPasswordUseCase: get<_i80.ResetPasswordUseCase>()));
  gh.lazySingleton<_i175.PayKhanepani>(() => _i175.PayKhanepani(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i110.UtilityPaymentRepository>()));
  gh.lazySingleton<_i176.PayNea>(() => _i176.PayNea(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i110.UtilityPaymentRepository>()));
  gh.lazySingleton<_i177.PurchaseSubscriptionFromPartnerService>(() =>
      _i177.PurchaseSubscriptionFromPartnerService(
          networkInfo: get<_i14.NetworkInfo>(),
          repository: get<_i110.UtilityPaymentRepository>()));
  gh.factory<_i178.RedeemCouponBloc>(() => _i178.RedeemCouponBloc(
      applyCoupon: get<_i127.ApplyCoupon>(),
      redeemCoupon: get<_i79.RedeemCoupon>()));
  gh.lazySingleton<_i179.ResumeWatcherBloc>(() => _i179.ResumeWatcherBloc(
      getResume: get<_i153.GetResume>(),
      deleteResumeData: get<_i132.DeleteResumeData>()));
  gh.lazySingleton<_i180.RewardPointRepository>(() =>
      _i181.RewardPointRepositoryImpl(
          dataSource: get<_i84.RewardPointsRemoteDataSource>(),
          logger: get<_i12.Logger>()));
  gh.factory<_i182.SearchBloc>(
      () => _i182.SearchBloc(get<_i154.GetSearchPageData>()));
  gh.factory<_i183.SignInFormBloc>(() => _i183.SignInFormBloc(
  ...
  gh.factory<_i184.SignUpFormBloc>(() => _i184.SignUpFormBloc(
      signUpWithEmailUsecase:
          get<_i92.SignUpWithEmailPasswordAndUserDetail>()));
  gh.factory<_i185.SubscriptionForPartnerServiceBloc>(() =>
      _i185.SubscriptionForPartnerServiceBloc(
          getSubscriptionDetailForPartnerService:
              get<_i155.GetSubscriptionDetailForPartnerService>(),
          purchaseSubscriptionFromPartnerService:
              get<_i177.PurchaseSubscriptionFromPartnerService>()));
  gh.lazySingleton<_i186.TopUpBalanceForMobile>(() =>
      _i186.TopUpBalanceForMobile(
          networkInfo: get<_i14.NetworkInfo>(),
          repository: get<_i110.UtilityPaymentRepository>()));
  gh.factory<_i187.TopUpBalanceInMobileBloc>(() =>
      _i187.TopUpBalanceInMobileBloc(
          topUpBalanceForMobile: get<_i186.TopUpBalanceForMobile>()));
  gh.lazySingleton<_i188.TransactionBloc>(() =>
      _i188.TransactionBloc(getTransaction: get<_i156.GetTransactions>()));
  gh.factory<_i189.UpdateProfileBloc>(() => _i189.UpdateProfileBloc(
      updateKycInfo: get<_i103.UpdateKycInfo>(),
      updateResumeImage: get<_i107.UpdateResumeImage>(),
      getListOfCityFromPrefectures: get<_i145.GetListOfCityFromPrefectures>()));
  gh.factory<_i190.AdsBloc>(() =>
      _i190.AdsBloc(get<_i135.GetAds>(), get<_i124.AdsRemoteDataSource>()));
  gh.factory<_i191.DownloadPdfBloc>(() => _i191.DownloadPdfBloc(
      getDownloadablePdfLink: get<_i139.GetDownloadablePdfLink>()));
  gh.factory<_i192.FavouriteNewsBloc>(() =>
      _i192.FavouriteNewsBloc(getFavouriteNews: get<_i140.GetFavouriteNews>()));
  gh.lazySingleton<_i193.GetNotifications>(() => _i193.GetNotifications(
      repository: get<_i168.NotificationRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i194.GetRewardPoints>(() => _i194.GetRewardPoints(
      repository: get<_i180.RewardPointRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.factory<_i195.JapaneseMannerBloc>(() => _i195.JapaneseMannerBloc(
      getJapaneseManner: get<_i196.GetJapaneseManner>()));
  gh.factory<_i197.JapaneseMannerCategoriesBloc>(() =>
      _i197.JapaneseMannerCategoriesBloc(
          getJapaneseMannerCategories:
              get<_i198.GetJapaneseMannerCategories>()));
  gh.factory<_i199.JapaneseMannerDetailBloc>(() =>
      _i199.JapaneseMannerDetailBloc(
          getJpMannerDetail: get<_i200.GetJapaneseMannerDetail>()));
  gh.factory<_i201.KhanepaniPaymentBloc>(() => _i201.KhanepaniPaymentBloc(
      get<_i133.EnquireKhanepani>(), get<_i175.PayKhanepani>()));
  gh.factory<_i202.NeaPaymentBloc>(
      () => _i202.NeaPaymentBloc(get<_i134.EnquiryNea>(), get<_i176.PayNea>()));
  gh.factory<_i203.NotificationsBloc>(() =>
      _i203.NotificationsBloc(getNotifications: get<_i193.GetNotifications>()));
  gh.factory<_i204.RewardPointBloc>(() =>
      _i204.RewardPointBloc(getRewardPoints: get<_i194.GetRewardPoints>()));
  gh.singleton<_i13.ConfigReader>(_i13.ConfigReaderImpl());
  gh.singleton<_i205.DBProvider>(_i205.DBProviderImpl());
  gh.singleton<_i70.NewsLocalProvider>(
      _i70.NewsLocalProviderImpl(provider: get<_i205.DBProvider>()));
  gh.singleton<_i78.PurchasePackage>(_i78.PurchasePackage(
      repository: get<_i75.PartnerServicesRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i206.GetAlertLocationBloc>(
      _i206.GetAlertLocationBloc(get<_i50.GetPlaceFromGPS>()));
  gh.singleton<_i171.GetPartnerServices>(_i171.GetPartnerServices(
      repository: get<_i75.PartnerServicesRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i173.GetPartnerServicesCategories>(
      _i173.GetPartnerServicesCategories(
          repository: get<_i75.PartnerServicesRepository>(),
          networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i196.GetJapaneseManner>(_i196.GetJapaneseManner(
      repository: get<_i159.JapaneseMannerRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i198.GetJapaneseMannerCategories>(
      _i198.GetJapaneseMannerCategories(
          repository: get<_i159.JapaneseMannerRepository>(),
          networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i200.GetJapaneseMannerDetail>(_i200.GetJapaneseMannerDetail(
      repository: get<_i159.JapaneseMannerRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  return get;
}

class _$HttpClientInjectableModule extends _i207.HttpClientInjectableModule {}

class _$FlutterStorageModule extends _i208.FlutterStorageModule {}

class _$GoogleLoginInjectableModule extends _i209.GoogleLoginInjectableModule {}

class _$DataConnectionCheckerModule extends _i210.DataConnectionCheckerModule {}

class _$SharedPreferenceModule extends _i211.SharedPreferenceModule {}
