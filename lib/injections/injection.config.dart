...
import '../core/database/local_database_provider.dart' as _i200;
...
import '../features/ads/domain/use_case/get_ads.dart' as _i134;
import '../features/ads/presentation/get_ads/ads_bloc.dart' as _i186;
...
import '../features/auth/presentation/sign_in_form/sign_in_form_bloc.dart'
    as _i179;
import '../features/auth/presentation/sign_up/sign_up_form_bloc.dart' as _i180;
...
import '../features/home/domain/usecases/get_home_page_data.dart' as _i140;
...
import '../features/news/domain/usecase/get_favourite_news.dart' as _i139;
import '../features/news/domain/usecase/get_latest_news.dart' as _i142;
import '../features/news/domain/usecase/get_news_for_you.dart' as _i146;
import '../features/news/domain/usecase/get_news_genre.dart' as _i147;
import '../features/news/domain/usecase/get_news_preferences.dart' as _i148;
...
import '../features/news/presentation/latest_news/latest_news_bloc.dart'
    as _i159;
import '../features/news/presentation/news_for_you/news_bloc.dart' as _i162;
import '../features/news/presentation/news_genre/news_genre_bloc.dart' as _i163;
...
import '../features/resume/domain/usecases/get_downloadable_pdf_link.dart'
    as _i138;
import '../features/resume/domain/usecases/get_resume.dart' as _i151;
...
import '../features/search/domain/usecases/get_search_page_data.dart' as _i152;
import '../features/search/presentation/bloc/search_bloc.dart' as _i178;
...
import '../features/transaction/domain/usecase/get_individual_transaction.dart'
    as _i141;
import '../features/transaction/domain/usecase/get_transaction.dart' as _i154;
...
import 'injectable/data_connection_checker_injectable_module.dart' as _i205;
import 'injectable/flutter_secure_storage_module.dart' as _i203;
import 'injectable/google_login_injectable_module.dart' as _i204;
import 'injectable/http_client_injectable_module.dart' as _i202;
import 'injectable/shared_preference_module.dart'
    as _i206; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i132.DeleteResumeData>(() => _i132.DeleteResumeData(
      repository: get<_i82.ResumeRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i133.EnquiryNea>(() => _i133.EnquiryNea(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i110.UtilityPaymentRepository>()));
  gh.lazySingleton<_i134.GetAds>(() => _i134.GetAds(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i125.AdsRepository>()));
  gh.factory<_i135.GetAlertPlacesBloc>(
      () => _i135.GetAlertPlacesBloc(get<_i43.GetAlertsPlaces>()));
  gh.lazySingleton<_i136.GetCountries>(() => _i136.GetCountries(
      repository: get<_i66.LocationInformationRepositoryProtocol>()));
  gh.factory<_i137.GetDisasterDetailBloc>(() => _i137.GetDisasterDetailBloc(
      getEarthquakes: get<_i48.GetEarthquakes>(),
      getVolcanoes: get<_i53.GetVolcanoes>()));
  gh.factory<_i138.GetDownloadablePdfLink>(() => _i138.GetDownloadablePdfLink(
      repository: get<_i82.ResumeRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i139.GetFavouriteNews>(() =>
      _i139.GetFavouriteNews(repository: get<_i71.NewsRepositoryProtocol>()));
  gh.lazySingleton<_i140.GetHomePageData>(() => _i140.GetHomePageData(
      repository: get<_i59.HomeReporisitory>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i141.GetIndivisualTransaction>(() =>
      _i141.GetIndivisualTransaction(
          repository: get<_i99.TransactionRepository>(),
          networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i142.GetLatestNews>(() => _i142.GetLatestNews(
      repository: get<_i71.NewsRepositoryProtocol>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i143.GetListOfCityFromPrefectures>(() =>
      _i143.GetListOfCityFromPrefectures(
          repository: get<_i66.LocationInformationRepositoryProtocol>()));
  gh.lazySingleton<_i144.GetListOfPaymentMethods>(() =>
      _i144.GetListOfPaymentMethods(
          networkInfo: get<_i14.NetworkInfo>(),
          repository: get<_i63.LoadBalanceRepositories>()));
  gh.lazySingleton<_i145.GetNeaOffice>(() => _i145.GetNeaOffice(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i110.UtilityPaymentRepository>()));
  gh.lazySingleton<_i146.GetNewsForYou>(() => _i146.GetNewsForYou(
      repository: get<_i71.NewsRepositoryProtocol>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i147.GetNewsGenre>(
      () => _i147.GetNewsGenre(repository: get<_i71.NewsRepositoryProtocol>()));
  gh.lazySingleton<_i148.GetNewsPreferences>(() =>
      _i148.GetNewsPreferences(repository: get<_i71.NewsRepositoryProtocol>()));
  gh.factory<_i149.GetPaymentMethodsBloc>(() => _i149.GetPaymentMethodsBloc(
      getListOfPaymentMethods: get<_i144.GetListOfPaymentMethods>(),
      deletecard: get<_i130.DeleteCard>()));
  gh.lazySingleton<_i150.GetPrefectureCityFromPostalCode>(() =>
      _i150.GetPrefectureCityFromPostalCode(
          repository: get<_i66.LocationInformationRepositoryProtocol>()));
  gh.factory<_i151.GetResume>(() => _i151.GetResume(
      repository: get<_i82.ResumeRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i152.GetSearchPageData>(() => _i152.GetSearchPageData(
      repository: get<_i86.SearchRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i153.GetSubscriptionDetailForPartnerService>(() =>
      _i153.GetSubscriptionDetailForPartnerService(
          networkInfo: get<_i14.NetworkInfo>(),
          repository: get<_i110.UtilityPaymentRepository>()));
  gh.lazySingleton<_i154.GetTransactions>(() => _i154.GetTransactions(
      repository: get<_i99.TransactionRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i155.HomePageDataBloc>(() =>
      _i155.HomePageDataBloc(getHomePageData: get<_i140.GetHomePageData>()));
  gh.factory<_i156.IndividualTransactionBloc>(() =>
      _i156.IndividualTransactionBloc(
          getIndividualTxn: get<_i141.GetIndivisualTransaction>()));
  gh.lazySingleton<_i157.JapaneseMannerRepository>(() =>
      _i158.JapaneseMannerRepositoryImpl(
          remoteDataSource: get<_i61.JapaneseMannersRemoteDataSource>(),
          logger: get<_i12.Logger>()));
  gh.lazySingleton<_i159.LatestNewsBloc>(
      () => _i159.LatestNewsBloc(getNews: get<_i142.GetLatestNews>()));
  gh.factory<_i160.LocationViaPostalCodeBloc>(() =>
      _i160.LocationViaPostalCodeBloc(
          getPrefectureCityFromPostalCode:
              get<_i150.GetPrefectureCityFromPostalCode>()));
  gh.factory<_i161.NeaOfficesBloc>(
      () => _i161.NeaOfficesBloc(get<_i145.GetNeaOffice>()));
  gh.lazySingleton<_i162.NewsBloc>(
      () => _i162.NewsBloc(getNews: get<_i146.GetNewsForYou>()));
  gh.factory<_i163.NewsGenreBloc>(
      () => _i163.NewsGenreBloc(getNewsGenre: get<_i147.GetNewsGenre>()));
  gh.factory<_i164.NewsPreferenceBloc>(() => _i164.NewsPreferenceBloc(
      getNewsPreferences: get<_i148.GetNewsPreferences>()));
  gh.lazySingleton<_i165.NotificationRepository>(() =>
      _i166.NotificationRepositoryImpl(
          dataSource: get<_i73.NotificationsRemoteDataSource>(),
          logger: get<_i12.Logger>()));
  gh.factory<_i167.ParnterServicesBloc>(() => _i167.ParnterServicesBloc(
      getPartnerServices: get<_i168.GetPartnerServices>()));
  gh.factory<_i169.PartnerServiceCategoriesBloc>(() =>
      _i169.PartnerServiceCategoriesBloc(
          getPartnerServicesCategories:
              get<_i170.GetPartnerServicesCategories>()));
  gh.factory<_i171.PasswordResetBloc>(() => _i171.PasswordResetBloc(
      resetPasswordUseCase: get<_i80.ResetPasswordUseCase>()));
  gh.lazySingleton<_i172.PayNea>(() => _i172.PayNea(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i110.UtilityPaymentRepository>()));
  gh.lazySingleton<_i173.PurchaseSubscriptionFromPartnerService>(() =>
      _i173.PurchaseSubscriptionFromPartnerService(
          networkInfo: get<_i14.NetworkInfo>(),
          repository: get<_i110.UtilityPaymentRepository>()));
  gh.factory<_i174.RedeemCouponBloc>(() => _i174.RedeemCouponBloc(
      applyCoupon: get<_i127.ApplyCoupon>(),
      redeemCoupon: get<_i79.RedeemCoupon>()));
  gh.lazySingleton<_i175.ResumeWatcherBloc>(() => _i175.ResumeWatcherBloc(
      getResume: get<_i151.GetResume>(),
      deleteResumeData: get<_i132.DeleteResumeData>()));
  gh.lazySingleton<_i176.RewardPointRepository>(() =>
      _i177.RewardPointRepositoryImpl(
          dataSource: get<_i84.RewardPointsRemoteDataSource>(),
          logger: get<_i12.Logger>()));
  gh.factory<_i178.SearchBloc>(
      () => _i178.SearchBloc(get<_i152.GetSearchPageData>()));
  gh.factory<_i179.SignInFormBloc>(() => _i179.SignInFormBloc(
  ...
  gh.factory<_i180.SignUpFormBloc>(() => _i180.SignUpFormBloc(
      signUpWithEmailUsecase:
          get<_i92.SignUpWithEmailPasswordAndUserDetail>()));
  gh.factory<_i181.SubscriptionForPartnerServiceBloc>(() =>
      _i181.SubscriptionForPartnerServiceBloc(
          getSubscriptionDetailForPartnerService:
              get<_i153.GetSubscriptionDetailForPartnerService>(),
          purchaseSubscriptionFromPartnerService:
              get<_i173.PurchaseSubscriptionFromPartnerService>()));
  gh.lazySingleton<_i182.TopUpBalanceForMobile>(() =>
      _i182.TopUpBalanceForMobile(
          networkInfo: get<_i14.NetworkInfo>(),
          repository: get<_i110.UtilityPaymentRepository>()));
  gh.factory<_i183.TopUpBalanceInMobileBloc>(() =>
      _i183.TopUpBalanceInMobileBloc(
          topUpBalanceForMobile: get<_i182.TopUpBalanceForMobile>()));
  gh.lazySingleton<_i184.TransactionBloc>(() =>
      _i184.TransactionBloc(getTransaction: get<_i154.GetTransactions>()));
  gh.factory<_i185.UpdateProfileBloc>(() => _i185.UpdateProfileBloc(
      updateKycInfo: get<_i103.UpdateKycInfo>(),
      updateResumeImage: get<_i107.UpdateResumeImage>(),
      getListOfCityFromPrefectures: get<_i143.GetListOfCityFromPrefectures>()));
  gh.factory<_i186.AdsBloc>(() =>
      _i186.AdsBloc(get<_i134.GetAds>(), get<_i124.AdsRemoteDataSource>()));
  gh.factory<_i187.DownloadPdfBloc>(() => _i187.DownloadPdfBloc(
      getDownloadablePdfLink: get<_i138.GetDownloadablePdfLink>()));
  gh.factory<_i188.FavouriteNewsBloc>(() =>
      _i188.FavouriteNewsBloc(getFavouriteNews: get<_i139.GetFavouriteNews>()));
  gh.lazySingleton<_i189.GetNotifications>(() => _i189.GetNotifications(
      repository: get<_i165.NotificationRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i190.GetRewardPoints>(() => _i190.GetRewardPoints(
      repository: get<_i176.RewardPointRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.factory<_i191.JapaneseMannerBloc>(() => _i191.JapaneseMannerBloc(
      getJapaneseManner: get<_i192.GetJapaneseManner>()));
  gh.factory<_i193.JapaneseMannerCategoriesBloc>(() =>
      _i193.JapaneseMannerCategoriesBloc(
          getJapaneseMannerCategories:
              get<_i194.GetJapaneseMannerCategories>()));
  gh.factory<_i195.JapaneseMannerDetailBloc>(() =>
      _i195.JapaneseMannerDetailBloc(
          getJpMannerDetail: get<_i196.GetJapaneseMannerDetail>()));
  gh.factory<_i197.NeaPaymentBloc>(
      () => _i197.NeaPaymentBloc(get<_i133.EnquiryNea>(), get<_i172.PayNea>()));
  gh.factory<_i198.NotificationsBloc>(() =>
      _i198.NotificationsBloc(getNotifications: get<_i189.GetNotifications>()));
  gh.factory<_i199.RewardPointBloc>(() =>
      _i199.RewardPointBloc(getRewardPoints: get<_i190.GetRewardPoints>()));
  gh.singleton<_i13.ConfigReader>(_i13.ConfigReaderImpl());
  gh.singleton<_i200.DBProvider>(_i200.DBProviderImpl());
  gh.singleton<_i70.NewsLocalProvider>(
      _i70.NewsLocalProviderImpl(provider: get<_i200.DBProvider>()));
  gh.singleton<_i78.PurchasePackage>(_i78.PurchasePackage(
      repository: get<_i75.PartnerServicesRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i201.GetAlertLocationBloc>(
      _i201.GetAlertLocationBloc(get<_i50.GetPlaceFromGPS>()));
  gh.singleton<_i168.GetPartnerServices>(_i168.GetPartnerServices(
      repository: get<_i75.PartnerServicesRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i170.GetPartnerServicesCategories>(
      _i170.GetPartnerServicesCategories(
          repository: get<_i75.PartnerServicesRepository>(),
          networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i192.GetJapaneseManner>(_i192.GetJapaneseManner(
      repository: get<_i157.JapaneseMannerRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i194.GetJapaneseMannerCategories>(
      _i194.GetJapaneseMannerCategories(
          repository: get<_i157.JapaneseMannerRepository>(),
          networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i196.GetJapaneseMannerDetail>(_i196.GetJapaneseMannerDetail(
      repository: get<_i157.JapaneseMannerRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  return get;
}

class _$HttpClientInjectableModule extends _i202.HttpClientInjectableModule {}

class _$FlutterStorageModule extends _i203.FlutterStorageModule {}

class _$GoogleLoginInjectableModule extends _i204.GoogleLoginInjectableModule {}

class _$DataConnectionCheckerModule extends _i205.DataConnectionCheckerModule {}

class _$SharedPreferenceModule extends _i206.SharedPreferenceModule {}
