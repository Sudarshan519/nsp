...
import '../core/database/local_database_provider.dart' as _i105;
...
import '../features/home/domain/usecases/get_home_page_data.dart' as _i81;
...
import '../features/news/domain/usecase/get_favourite_news.dart' as _i80;
import '../features/news/domain/usecase/get_latest_news.dart' as _i82;
...
import 'injectable/data_connection_checker_injectable_module.dart' as _i109;
import 'injectable/flutter_secure_storage_module.dart' as _i107;
import 'injectable/google_login_injectable_module.dart' as _i108;
import 'injectable/http_client_injectable_module.dart' as _i106;
import 'injectable/shared_preference_module.dart'
    as _i110; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i79.GetDownloadablePdfLink>(() => _i79.GetDownloadablePdfLink(
      repository: get<_i57.ResumeRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i80.GetFavouriteNews>(() =>
      _i80.GetFavouriteNews(repository: get<_i49.NewsRepositoryProtocol>()));
  gh.lazySingleton<_i81.GetHomePageData>(() => _i81.GetHomePageData(
      repository: get<_i38.HomeReporisitory>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i82.GetLatestNews>(() => _i82.GetLatestNews(
  ...
  gh.lazySingleton<_i85.GetNewsGenre>(
      () => _i85.GetNewsGenre(repository: get<_i49.NewsRepositoryProtocol>()));
  gh.lazySingleton<_i86.GetNewsPreferences>(() =>
      _i86.GetNewsPreferences(repository: get<_i49.NewsRepositoryProtocol>()));
  ...
  gh.lazySingleton<_i89.HomePageDataBloc>(() =>
      _i89.HomePageDataBloc(getHomePageData: get<_i81.GetHomePageData>()));
  gh.factory<_i90.JapaneseMannerBloc>(() => _i90.JapaneseMannerBloc(
      getJapaneseManner: get<_i91.GetJapaneseManner>()));
  gh.factory<_i92.JapaneseMannerCategoriesBloc>(() =>
      _i92.JapaneseMannerCategoriesBloc(
          getJapaneseMannerCategories:
              get<_i93.GetJapaneseMannerCategories>()));
  gh.lazySingleton<_i94.LatestNewsBloc>(
      () => _i94.LatestNewsBloc(getNews: get<_i82.GetLatestNews>()));
  ...
  gh.lazySingleton<_i99.ResumeWatcherBloc>(
      () => _i99.ResumeWatcherBloc(getResume: get<_i88.GetResume>()));
  ...
  gh.factory<_i103.DownloadPdfBloc>(() => _i103.DownloadPdfBloc(
      getDownloadablePdfLink: get<_i79.GetDownloadablePdfLink>()));
  gh.factory<_i104.FavouriteNewsBloc>(() =>
      _i104.FavouriteNewsBloc(getFavouriteNews: get<_i80.GetFavouriteNews>()));
  gh.singleton<_i10.ConfigReader>(_i10.ConfigReaderImpl());
  gh.singleton<_i105.DBProvider>(_i105.DBProviderImpl());
  gh.singleton<_i48.NewsLocalProvider>(
      _i48.NewsLocalProviderImpl(provider: get<_i105.DBProvider>()));
  ...
  gh.singleton<_i54.GetPartnerServicesCategories>(
      _i54.GetPartnerServicesCategories(
          repository: get<_i17.PartnerServicesRepository>(),
          networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i91.GetJapaneseManner>(_i91.GetJapaneseManner(
      repository: get<_i40.JapaneseMannerRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i93.GetJapaneseMannerCategories>(
      _i93.GetJapaneseMannerCategories(
          repository: get<_i40.JapaneseMannerRepository>(),
          networkInfo: get<_i14.NetworkInfo>()));
  return get;
}

class _$HttpClientInjectableModule extends _i106.HttpClientInjectableModule {}

class _$FlutterStorageModule extends _i107.FlutterStorageModule {}

class _$GoogleLoginInjectableModule extends _i108.GoogleLoginInjectableModule {}

class _$DataConnectionCheckerModule extends _i109.DataConnectionCheckerModule {}

class _$SharedPreferenceModule extends _i110.SharedPreferenceModule {}
