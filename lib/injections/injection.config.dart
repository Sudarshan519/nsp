...
import '../features/ads/domain/use_case/get_ads.dart' as _i143;
...
import '../features/app_update/domain/repository/app_update_repository.dart'
    as _i133;
import '../features/app_update/domain/use_case/get_app_update.dart' as _i145;
...
import '../features/auth/presentation/sign_in_form/sign_in_form_bloc.dart'
    as _i192;
import '../features/auth/presentation/sign_up/sign_up_form_bloc.dart' as _i193;
...
import '../features/home/domain/usecases/get_home_page_data.dart' as _i150;
...
import '../features/news/domain/usecase/get_favourite_news.dart' as _i149;
import '../features/news/domain/usecase/get_latest_news.dart' as _i153;
import '../features/news/domain/usecase/get_news_for_you.dart' as _i157;
import '../features/news/domain/usecase/get_news_genre.dart' as _i158;
import '../features/news/domain/usecase/get_news_preferences.dart' as _i159;
...
import '../features/news/presentation/latest_news/latest_news_bloc.dart'
    as _i171;
import '../features/news/presentation/news_for_you/news_bloc.dart' as _i174;
import '../features/news/presentation/news_genre/news_genre_bloc.dart' as _i175;
...
import '../features/resume/domain/usecases/get_downloadable_pdf_link.dart'
    as _i148;
import '../features/resume/domain/usecases/get_resume.dart' as _i162;
...
import '../features/search/domain/usecases/get_search_page_data.dart' as _i163;
import '../features/search/presentation/bloc/search_bloc.dart' as _i191;
...
import '../features/transaction/domain/usecase/get_individual_transaction.dart'
    as _i151;
import '../features/transaction/domain/usecase/get_transaction.dart' as _i165;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i142.EnquiryNea>(() => _i142.EnquiryNea(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i113.UtilityPaymentRepository>()));
  gh.lazySingleton<_i143.GetAds>(() => _i143.GetAds(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i130.AdsRepository>()));
  gh.factory<_i144.GetAlertPlacesBloc>(
      () => _i144.GetAlertPlacesBloc(get<_i43.GetAlertsPlaces>()));
  gh.lazySingleton<_i145.GetAppUpdate>(() => _i145.GetAppUpdate(
      repository: get<_i133.AppUpdateRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i146.GetCountries>(() => _i146.GetCountries(
      repository: get<_i66.LocationInformationRepositoryProtocol>()));
  gh.factory<_i147.GetDisasterDetailBloc>(() => _i147.GetDisasterDetailBloc(
      getEarthquakes: get<_i48.GetEarthquakes>(),
      getVolcanoes: get<_i53.GetVolcanoes>()));
  gh.factory<_i148.GetDownloadablePdfLink>(() => _i148.GetDownloadablePdfLink(
      repository: get<_i83.ResumeRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i149.GetFavouriteNews>(() =>
      _i149.GetFavouriteNews(repository: get<_i71.NewsRepositoryProtocol>()));
  gh.lazySingleton<_i150.GetHomePageData>(() => _i150.GetHomePageData(
      repository: get<_i59.HomeReporisitory>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i151.GetIndivisualTransaction>(() =>
      _i151.GetIndivisualTransaction(
          repository: get<_i102.TransactionRepository>(),
          networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i152.GetKhanepaniOffices>(() => _i152.GetKhanepaniOffices(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i113.UtilityPaymentRepository>()));
  gh.lazySingleton<_i153.GetLatestNews>(() => _i153.GetLatestNews(
      repository: get<_i71.NewsRepositoryProtocol>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i154.GetListOfCityFromPrefectures>(() =>
      _i154.GetListOfCityFromPrefectures(
          repository: get<_i66.LocationInformationRepositoryProtocol>()));
  gh.lazySingleton<_i155.GetListOfPaymentMethods>(() =>
      _i155.GetListOfPaymentMethods(
          networkInfo: get<_i14.NetworkInfo>(),
          repository: get<_i63.LoadBalanceRepositories>()));
  gh.lazySingleton<_i156.GetNeaOffice>(() => _i156.GetNeaOffice(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i113.UtilityPaymentRepository>()));
  gh.lazySingleton<_i157.GetNewsForYou>(() => _i157.GetNewsForYou(
      repository: get<_i71.NewsRepositoryProtocol>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i158.GetNewsGenre>(
      () => _i158.GetNewsGenre(repository: get<_i71.NewsRepositoryProtocol>()));
  gh.lazySingleton<_i159.GetNewsPreferences>(() =>
      _i159.GetNewsPreferences(repository: get<_i71.NewsRepositoryProtocol>()));
  gh.factory<_i160.GetPaymentMethodsBloc>(() => _i160.GetPaymentMethodsBloc(
      getListOfPaymentMethods: get<_i155.GetListOfPaymentMethods>(),
      deletecard: get<_i138.DeleteCard>()));
  gh.lazySingleton<_i161.GetPrefectureCityFromPostalCode>(() =>
      _i161.GetPrefectureCityFromPostalCode(
          repository: get<_i66.LocationInformationRepositoryProtocol>()));
  gh.factory<_i162.GetResume>(() => _i162.GetResume(
      repository: get<_i83.ResumeRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i163.GetSearchPageData>(() => _i163.GetSearchPageData(
      repository: get<_i87.SearchRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i164.GetSubscriptionDetailForPartnerService>(() =>
      _i164.GetSubscriptionDetailForPartnerService(
          networkInfo: get<_i14.NetworkInfo>(),
          repository: get<_i113.UtilityPaymentRepository>()));
  gh.lazySingleton<_i165.GetTransactions>(() => _i165.GetTransactions(
      repository: get<_i102.TransactionRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i166.HomePageDataBloc>(() =>
      _i166.HomePageDataBloc(getHomePageData: get<_i150.GetHomePageData>()));
  gh.factory<_i167.IndividualTransactionBloc>(() =>
      _i167.IndividualTransactionBloc(
          getIndividualTxn: get<_i151.GetIndivisualTransaction>()));
  gh.lazySingleton<_i168.JapaneseMannerRepository>(() =>
      _i169.JapaneseMannerRepositoryImpl(
          remoteDataSource: get<_i61.JapaneseMannersRemoteDataSource>(),
          logger: get<_i12.Logger>()));
  gh.factory<_i170.KhanepaniOfficesBloc>(
      () => _i170.KhanepaniOfficesBloc(get<_i152.GetKhanepaniOffices>()));
  gh.lazySingleton<_i171.LatestNewsBloc>(
      () => _i171.LatestNewsBloc(getNews: get<_i153.GetLatestNews>()));
  gh.factory<_i172.LocationViaPostalCodeBloc>(() =>
      _i172.LocationViaPostalCodeBloc(
          getPrefectureCityFromPostalCode:
              get<_i161.GetPrefectureCityFromPostalCode>()));
  gh.factory<_i173.NeaOfficesBloc>(
      () => _i173.NeaOfficesBloc(get<_i156.GetNeaOffice>()));
  gh.lazySingleton<_i174.NewsBloc>(
      () => _i174.NewsBloc(getNews: get<_i157.GetNewsForYou>()));
  gh.factory<_i175.NewsGenreBloc>(
      () => _i175.NewsGenreBloc(getNewsGenre: get<_i158.GetNewsGenre>()));
  gh.factory<_i176.NewsPreferenceBloc>(() => _i176.NewsPreferenceBloc(
      getNewsPreferences: get<_i159.GetNewsPreferences>()));
  gh.lazySingleton<_i177.NotificationRepository>(() =>
      _i178.NotificationRepositoryImpl(
          dataSource: get<_i73.NotificationsRemoteDataSource>(),
          logger: get<_i12.Logger>()));
  gh.factory<_i179.ParnterServicesBloc>(() => _i179.ParnterServicesBloc(
      getPartnerServices: get<_i180.GetPartnerServices>()));
  gh.factory<_i181.PartnerServiceCategoriesBloc>(() =>
      _i181.PartnerServiceCategoriesBloc(
          getPartnerServicesCategories:
              get<_i182.GetPartnerServicesCategories>()));
  gh.factory<_i183.PasswordResetBloc>(() => _i183.PasswordResetBloc(
      resetPasswordUseCase: get<_i81.ResetPasswordUseCase>()));
  gh.lazySingleton<_i184.PayKhanepani>(() => _i184.PayKhanepani(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i113.UtilityPaymentRepository>()));
  gh.lazySingleton<_i185.PayNea>(() => _i185.PayNea(
      networkInfo: get<_i14.NetworkInfo>(),
      repository: get<_i113.UtilityPaymentRepository>()));
  gh.lazySingleton<_i186.PurchaseSubscriptionFromPartnerService>(() =>
      _i186.PurchaseSubscriptionFromPartnerService(
          networkInfo: get<_i14.NetworkInfo>(),
          repository: get<_i113.UtilityPaymentRepository>()));
  gh.factory<_i187.RedeemCouponBloc>(() => _i187.RedeemCouponBloc(
      applyCoupon: get<_i135.ApplyCoupon>(),
      redeemCoupon: get<_i79.RedeemCoupon>()));
  gh.lazySingleton<_i188.ResumeWatcherBloc>(() => _i188.ResumeWatcherBloc(
      getResume: get<_i162.GetResume>(),
      deleteResumeData: get<_i140.DeleteResumeData>()));
  gh.lazySingleton<_i189.RewardPointRepository>(() =>
      _i190.RewardPointRepositoryImpl(
          dataSource: get<_i85.RewardPointsRemoteDataSource>(),
          logger: get<_i12.Logger>()));
  gh.factory<_i191.SearchBloc>(
      () => _i191.SearchBloc(get<_i163.GetSearchPageData>()));
  gh.factory<_i192.SignInFormBloc>(() => _i192.SignInFormBloc(
  ...
  gh.factory<_i193.SignUpFormBloc>(() => _i193.SignUpFormBloc(
  ...
  gh.factory<_i194.SubscriptionForPartnerServiceBloc>(() =>
      _i194.SubscriptionForPartnerServiceBloc(
          getSubscriptionDetailForPartnerService:
              get<_i164.GetSubscriptionDetailForPartnerService>(),
          purchaseSubscriptionFromPartnerService:
              get<_i186.PurchaseSubscriptionFromPartnerService>()));
  ...
  gh.lazySingleton<_i197.TransactionBloc>(() =>
      _i197.TransactionBloc(getTransaction: get<_i165.GetTransactions>()));
  gh.factory<_i198.UpdateProfileBloc>(() => _i198.UpdateProfileBloc(
      ...
      getListOfCityFromPrefectures: get<_i154.GetListOfCityFromPrefectures>()));
  gh.factory<_i199.AdsBloc>(() =>
      _i199.AdsBloc(get<_i143.GetAds>(), get<_i129.AdsRemoteDataSource>()));
  gh.lazySingleton<_i200.AppUpdateBloc>(
      () => _i200.AppUpdateBloc(get<_i145.GetAppUpdate>()));
  gh.factory<_i201.DownloadPdfBloc>(() => _i201.DownloadPdfBloc(
      getDownloadablePdfLink: get<_i148.GetDownloadablePdfLink>()));
  gh.factory<_i202.FavouriteNewsBloc>(() =>
      _i202.FavouriteNewsBloc(getFavouriteNews: get<_i149.GetFavouriteNews>()));
  gh.lazySingleton<_i203.GetNotifications>(() => _i203.GetNotifications(
      repository: get<_i177.NotificationRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i204.GetRewardPoints>(() => _i204.GetRewardPoints(
      repository: get<_i189.RewardPointRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  ...
  gh.factory<_i211.KhanepaniPaymentBloc>(() => _i211.KhanepaniPaymentBloc(
      get<_i141.EnquireKhanepani>(), get<_i184.PayKhanepani>()));
  gh.factory<_i212.NeaPaymentBloc>(
      () => _i212.NeaPaymentBloc(get<_i142.EnquiryNea>(), get<_i185.PayNea>()));
  ...
  gh.singleton<_i180.GetPartnerServices>(_i180.GetPartnerServices(
      repository: get<_i75.PartnerServicesRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i182.GetPartnerServicesCategories>(
      _i182.GetPartnerServicesCategories(
          repository: get<_i75.PartnerServicesRepository>(),
          networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i206.GetJapaneseManner>(_i206.GetJapaneseManner(
      repository: get<_i168.JapaneseMannerRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
