...
import '../core/database/local_database_provider.dart' as _i181;
...
import '../features/ads/presentation/get_ads/ads_bloc.dart' as _i168;
...
import '../features/auth/presentation/sign_in_form/sign_in_form_bloc.dart'
    as _i161;
import '../features/auth/presentation/sign_up/sign_up_form_bloc.dart' as _i162;
...
import '../features/home/domain/usecases/get_home_page_data.dart' as _i125;
...
import '../features/news/domain/usecase/get_favourite_news.dart' as _i124;
import '../features/news/domain/usecase/get_latest_news.dart' as _i127;
import '../features/news/domain/usecase/get_news_for_you.dart' as _i130;
import '../features/news/domain/usecase/get_news_genre.dart' as _i131;
import '../features/news/domain/usecase/get_news_preferences.dart' as _i132;
...
import '../features/news/presentation/latest_news/latest_news_bloc.dart'
    as _i143;
import '../features/news/presentation/news_for_you/news_bloc.dart' as _i145;
import '../features/news/presentation/news_genre/news_genre_bloc.dart' as _i146;
...
import '../features/resume/domain/usecases/get_downloadable_pdf_link.dart'
    as _i123;
import '../features/resume/domain/usecases/get_resume.dart' as _i135;
...
import '../features/search/domain/usecases/get_search_page_data.dart' as _i136;
import '../features/search/presentation/bloc/search_bloc.dart' as _i160;
...
import '../features/transaction/domain/usecase/get_individual_transaction.dart'
    as _i126;
import '../features/transaction/domain/usecase/get_transaction.dart' as _i138;
...
import 'injectable/data_connection_checker_injectable_module.dart' as _i185;
import 'injectable/flutter_secure_storage_module.dart' as _i183;
import 'injectable/google_login_injectable_module.dart' as _i184;
import 'injectable/http_client_injectable_module.dart' as _i182;
import 'injectable/shared_preference_module.dart'
    as _i186; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i8.GetAlertLocationBloc>(() => _i8.GetAlertLocationBloc());
  ...
  gh.lazySingleton<_i44.GetWalletUser>(
      () => _i44.GetWalletUser(repository: get<_i25.AuthRepository>()));
  ...
  gh.lazySingleton<_i57.LogoutUser>(
      () => _i57.LogoutUser(repository: get<_i25.AuthRepository>()));
  ...
  gh.factory<_i121.GetAlertPlacesBloc>(
      () => _i121.GetAlertPlacesBloc(get<_i35.GetAlertsPlaces>()));
  gh.lazySingleton<_i122.GetCountries>(() => _i122.GetCountries(
      repository: get<_i55.LocationInformationRepositoryProtocol>()));
  gh.factory<_i123.GetDownloadablePdfLink>(() => _i123.GetDownloadablePdfLink(
      repository: get<_i71.ResumeRepository>(),
      networkInfo: get<_i15.NetworkInfo>()));
  gh.lazySingleton<_i124.GetFavouriteNews>(() =>
      _i124.GetFavouriteNews(repository: get<_i60.NewsRepositoryProtocol>()));
  gh.lazySingleton<_i125.GetHomePageData>(() => _i125.GetHomePageData(
      repository: get<_i48.HomeReporisitory>(),
      networkInfo: get<_i15.NetworkInfo>()));
  gh.lazySingleton<_i126.GetIndivisualTransaction>(() =>
      _i126.GetIndivisualTransaction(
          repository: get<_i88.TransactionRepository>(),
          networkInfo: get<_i15.NetworkInfo>()));
  gh.lazySingleton<_i127.GetLatestNews>(() => _i127.GetLatestNews(
      repository: get<_i60.NewsRepositoryProtocol>(),
      networkInfo: get<_i15.NetworkInfo>()));
  gh.lazySingleton<_i128.GetListOfCityFromPrefectures>(() =>
      _i128.GetListOfCityFromPrefectures(
          repository: get<_i55.LocationInformationRepositoryProtocol>()));
  gh.lazySingleton<_i129.GetListOfPaymentMethods>(() =>
      _i129.GetListOfPaymentMethods(
          networkInfo: get<_i15.NetworkInfo>(),
          repository: get<_i52.LoadBalanceRepositories>()));
  gh.lazySingleton<_i130.GetNewsForYou>(() => _i130.GetNewsForYou(
      repository: get<_i60.NewsRepositoryProtocol>(),
      networkInfo: get<_i15.NetworkInfo>()));
  gh.lazySingleton<_i131.GetNewsGenre>(
      () => _i131.GetNewsGenre(repository: get<_i60.NewsRepositoryProtocol>()));
  gh.lazySingleton<_i132.GetNewsPreferences>(() =>
      _i132.GetNewsPreferences(repository: get<_i60.NewsRepositoryProtocol>()));
  gh.factory<_i133.GetPaymentMethodsBloc>(() => _i133.GetPaymentMethodsBloc(
      getListOfPaymentMethods: get<_i129.GetListOfPaymentMethods>(),
      deletecard: get<_i117.DeleteCard>()));
  gh.lazySingleton<_i134.GetPrefectureCityFromPostalCode>(() =>
      _i134.GetPrefectureCityFromPostalCode(
          repository: get<_i55.LocationInformationRepositoryProtocol>()));
  gh.factory<_i135.GetResume>(() => _i135.GetResume(
      repository: get<_i71.ResumeRepository>(),
      networkInfo: get<_i15.NetworkInfo>()));
  gh.lazySingleton<_i136.GetSearchPageData>(() => _i136.GetSearchPageData(
      repository: get<_i75.SearchRepository>(),
      networkInfo: get<_i15.NetworkInfo>()));
  gh.lazySingleton<_i137.GetSubscriptionDetailForPartnerService>(() =>
      _i137.GetSubscriptionDetailForPartnerService(
          networkInfo: get<_i15.NetworkInfo>(),
          repository: get<_i99.UtilityPaymentRepository>()));
  gh.lazySingleton<_i138.GetTransactions>(() => _i138.GetTransactions(
      repository: get<_i88.TransactionRepository>(),
      networkInfo: get<_i15.NetworkInfo>()));
  gh.lazySingleton<_i139.HomePageDataBloc>(() =>
      _i139.HomePageDataBloc(getHomePageData: get<_i125.GetHomePageData>()));
  gh.factory<_i140.IndividualTransactionBloc>(() =>
      _i140.IndividualTransactionBloc(
          getIndividualTxn: get<_i126.GetIndivisualTransaction>()));
  gh.lazySingleton<_i141.JapaneseMannerRepository>(() =>
      _i142.JapaneseMannerRepositoryImpl(
          remoteDataSource: get<_i50.JapaneseMannersRemoteDataSource>(),
          logger: get<_i13.Logger>()));
  gh.lazySingleton<_i143.LatestNewsBloc>(
      () => _i143.LatestNewsBloc(getNews: get<_i127.GetLatestNews>()));
  gh.factory<_i144.LocationViaPostalCodeBloc>(() =>
      _i144.LocationViaPostalCodeBloc(
          getPrefectureCityFromPostalCode:
              get<_i134.GetPrefectureCityFromPostalCode>()));
  gh.lazySingleton<_i145.NewsBloc>(
      () => _i145.NewsBloc(getNews: get<_i130.GetNewsForYou>()));
  gh.factory<_i146.NewsGenreBloc>(
      () => _i146.NewsGenreBloc(getNewsGenre: get<_i131.GetNewsGenre>()));
  gh.factory<_i147.NewsPreferenceBloc>(() => _i147.NewsPreferenceBloc(
      getNewsPreferences: get<_i132.GetNewsPreferences>()));
  gh.lazySingleton<_i148.NotificationRepository>(() =>
      _i149.NotificationRepositoryImpl(
          dataSource: get<_i62.NotificationsRemoteDataSource>(),
          logger: get<_i13.Logger>()));
  gh.factory<_i150.ParnterServicesBloc>(() => _i150.ParnterServicesBloc(
      getPartnerServices: get<_i151.GetPartnerServices>()));
  gh.factory<_i152.PartnerServiceCategoriesBloc>(() =>
      _i152.PartnerServiceCategoriesBloc(
          getPartnerServicesCategories:
              get<_i153.GetPartnerServicesCategories>()));
  gh.factory<_i154.PasswordResetBloc>(() => _i154.PasswordResetBloc(
      resetPasswordUseCase: get<_i69.ResetPasswordUseCase>()));
  gh.lazySingleton<_i155.PurchaseSubscriptionFromPartnerService>(() =>
      _i155.PurchaseSubscriptionFromPartnerService(
          networkInfo: get<_i15.NetworkInfo>(),
          repository: get<_i99.UtilityPaymentRepository>()));
  gh.factory<_i156.RedeemCouponBloc>(() => _i156.RedeemCouponBloc(
      applyCoupon: get<_i116.ApplyCoupon>(),
      redeemCoupon: get<_i68.RedeemCoupon>()));
  gh.lazySingleton<_i157.ResumeWatcherBloc>(() => _i157.ResumeWatcherBloc(
      getResume: get<_i135.GetResume>(),
      deleteResumeData: get<_i119.DeleteResumeData>()));
  gh.lazySingleton<_i158.RewardPointRepository>(() =>
      _i159.RewardPointRepositoryImpl(
          dataSource: get<_i73.RewardPointsRemoteDataSource>(),
          logger: get<_i13.Logger>()));
  gh.factory<_i160.SearchBloc>(
      () => _i160.SearchBloc(get<_i136.GetSearchPageData>()));
  gh.factory<_i161.SignInFormBloc>(() => _i161.SignInFormBloc(
  ...
  gh.factory<_i162.SignUpFormBloc>(() => _i162.SignUpFormBloc(
      signUpWithEmailUsecase:
          get<_i81.SignUpWithEmailPasswordAndUserDetail>()));
  gh.factory<_i163.SubscriptionForPartnerServiceBloc>(() =>
      _i163.SubscriptionForPartnerServiceBloc(
          getSubscriptionDetailForPartnerService:
              get<_i137.GetSubscriptionDetailForPartnerService>(),
          purchaseSubscriptionFromPartnerService:
              get<_i155.PurchaseSubscriptionFromPartnerService>()));
  gh.lazySingleton<_i164.TopUpBalanceForMobile>(() =>
      _i164.TopUpBalanceForMobile(
          networkInfo: get<_i15.NetworkInfo>(),
          repository: get<_i99.UtilityPaymentRepository>()));
  gh.factory<_i165.TopUpBalanceInMobileBloc>(() =>
      _i165.TopUpBalanceInMobileBloc(
          topUpBalanceForMobile: get<_i164.TopUpBalanceForMobile>()));
  gh.lazySingleton<_i166.TransactionBloc>(() =>
      _i166.TransactionBloc(getTransaction: get<_i138.GetTransactions>()));
  gh.factory<_i167.UpdateProfileBloc>(() => _i167.UpdateProfileBloc(
      updateKycInfo: get<_i92.UpdateKycInfo>(),
      updateResumeImage: get<_i96.UpdateResumeImage>(),
      getListOfCityFromPrefectures: get<_i128.GetListOfCityFromPrefectures>()));
  gh.factory<_i168.AdsBloc>(() =>
      _i168.AdsBloc(get<_i120.GetAds>(), get<_i113.AdsRemoteDataSource>()));
  gh.factory<_i169.DownloadPdfBloc>(() => _i169.DownloadPdfBloc(
      getDownloadablePdfLink: get<_i123.GetDownloadablePdfLink>()));
  gh.factory<_i170.FavouriteNewsBloc>(() =>
      _i170.FavouriteNewsBloc(getFavouriteNews: get<_i124.GetFavouriteNews>()));
  gh.lazySingleton<_i171.GetNotifications>(() => _i171.GetNotifications(
      repository: get<_i148.NotificationRepository>(),
      networkInfo: get<_i15.NetworkInfo>()));
  gh.lazySingleton<_i172.GetRewardPoints>(() => _i172.GetRewardPoints(
      repository: get<_i158.RewardPointRepository>(),
      networkInfo: get<_i15.NetworkInfo>()));
  gh.factory<_i173.JapaneseMannerBloc>(() => _i173.JapaneseMannerBloc(
      getJapaneseManner: get<_i174.GetJapaneseManner>()));
  gh.factory<_i175.JapaneseMannerCategoriesBloc>(() =>
      _i175.JapaneseMannerCategoriesBloc(
          getJapaneseMannerCategories:
              get<_i176.GetJapaneseMannerCategories>()));
  gh.factory<_i177.JapaneseMannerDetailBloc>(() =>
      _i177.JapaneseMannerDetailBloc(
          getJpMannerDetail: get<_i178.GetJapaneseMannerDetail>()));
  gh.factory<_i179.NotificationsBloc>(() =>
      _i179.NotificationsBloc(getNotifications: get<_i171.GetNotifications>()));
  gh.factory<_i180.RewardPointBloc>(() =>
      _i180.RewardPointBloc(getRewardPoints: get<_i172.GetRewardPoints>()));
  gh.singleton<_i14.ConfigReader>(_i14.ConfigReaderImpl());
  gh.singleton<_i181.DBProvider>(_i181.DBProviderImpl());
  gh.singleton<_i59.NewsLocalProvider>(
      _i59.NewsLocalProviderImpl(provider: get<_i181.DBProvider>()));
  gh.singleton<_i67.PurchasePackage>(_i67.PurchasePackage(
      repository: get<_i64.PartnerServicesRepository>(),
      networkInfo: get<_i15.NetworkInfo>()));
  gh.singleton<_i151.GetPartnerServices>(_i151.GetPartnerServices(
      repository: get<_i64.PartnerServicesRepository>(),
      networkInfo: get<_i15.NetworkInfo>()));
  gh.singleton<_i153.GetPartnerServicesCategories>(
      _i153.GetPartnerServicesCategories(
          repository: get<_i64.PartnerServicesRepository>(),
          networkInfo: get<_i15.NetworkInfo>()));
  gh.singleton<_i174.GetJapaneseManner>(_i174.GetJapaneseManner(
      repository: get<_i141.JapaneseMannerRepository>(),
      networkInfo: get<_i15.NetworkInfo>()));
  gh.singleton<_i176.GetJapaneseMannerCategories>(
      _i176.GetJapaneseMannerCategories(
          repository: get<_i141.JapaneseMannerRepository>(),
          networkInfo: get<_i15.NetworkInfo>()));
  gh.singleton<_i178.GetJapaneseMannerDetail>(_i178.GetJapaneseMannerDetail(
      repository: get<_i141.JapaneseMannerRepository>(),
      networkInfo: get<_i15.NetworkInfo>()));
  return get;
}

class _$HttpClientInjectableModule extends _i182.HttpClientInjectableModule {}

class _$FlutterStorageModule extends _i183.FlutterStorageModule {}

class _$GoogleLoginInjectableModule extends _i184.GoogleLoginInjectableModule {}

class _$DataConnectionCheckerModule extends _i185.DataConnectionCheckerModule {}

class _$SharedPreferenceModule extends _i186.SharedPreferenceModule {}
