...
import '../core/database/local_database_provider.dart' as _i89;
...
import '../features/alerts/domain/usecase/get_volcanoes.dart' as _i32;
...
import '../features/auth/domain/usecase/sign_in_with_apple.dart' as _i52;
import '../features/auth/domain/usecase/sign_in_with_email.dart' as _i53;
import '../features/auth/domain/usecase/sign_in_with_facebook.dart' as _i54;
import '../features/auth/domain/usecase/sign_in_with_google.dart' as _i55;
import '../features/auth/domain/usecase/sign_up_user.dart' as _i56;
import '../features/auth/domain/usecase/verify_email.dart' as _i65;
import '../features/auth/presentation/sign_in_form/sign_in_form_bloc.dart'
    as _i85;
import '../features/auth/presentation/sign_up/sign_up_form_bloc.dart' as _i86;
...
import '../features/news/domain/usecase/get_news_for_you.dart' as _i71;
import '../features/news/domain/usecase/get_news_genre.dart' as _i72;
import '../features/news/domain/usecase/get_news_preferences.dart' as _i73;
...
import '../features/news/presentation/latest_news/latest_news_bloc.dart'
    as _i80;
import '../features/news/presentation/news_for_you/news_bloc.dart' as _i81;
import '../features/news/presentation/news_genre/news_genre_bloc.dart' as _i82;
...
import '../features/resume/data/data_source/resume_remote_data_source.dart'
    as _i49;
import '../features/resume/data/repository/resume_repository.dart' as _i51;
import '../features/resume/domain/repository/resume_repository.dart' as _i50;
import '../features/resume/domain/usecases/get_downloadable_pdf_link.dart'
    as _i67;
import '../features/resume/domain/usecases/get_resume.dart' as _i74;
import '../features/resume/domain/usecases/update_academics_info.dart' as _i58;
import '../features/resume/domain/usecases/update_address_info.dart' as _i59;
import '../features/resume/domain/usecases/update_other_info.dart' as _i60;
import '../features/resume/domain/usecases/update_personal_info.dart' as _i61;
import '../features/resume/domain/usecases/update_qualification_info.dart'
    as _i62;
import '../features/resume/domain/usecases/update_resume_image.dart' as _i63;
import '../features/resume/domain/usecases/update_work_info.dart' as _i64;
...
import '../features/resume/presentation/resume_watcher/resume_watcher_bloc.dart'
    as _i84;
import '../features/splash/presentation/splash_bloc.dart' as _i57;
import '../utils/config_reader.dart' as _i9;
import 'injectable/data_connection_checker_injectable_module.dart' as _i91;
import 'injectable/flutter_secure_storage_module.dart' as _i92;
import 'injectable/google_login_injectable_module.dart' as _i93;
import 'injectable/http_client_injectable_module.dart' as _i90;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i29.GetEarthquakes>(() => _i29.GetEarthquakes(
      repository: get<_i20.AlertRepository>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.lazySingleton<_i30.GetListOfCityFromPrefectures>(() =>
      _i30.GetListOfCityFromPrefectures(
          repository: get<_i11.LocationInformationRepositoryProtocol>()));
  gh.lazySingleton<_i31.GetPrefectureCityFromPostalCode>(() =>
      _i31.GetPrefectureCityFromPostalCode(
          repository: get<_i11.LocationInformationRepositoryProtocol>()));
  gh.lazySingleton<_i32.GetVolcanoes>(() => _i32.GetVolcanoes(
      repository: get<_i20.AlertRepository>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.lazySingleton<_i33.GetWalletUser>(
      () => _i33.GetWalletUser(repository: get<_i24.AuthRepository>()));
  ...
  gh.lazySingleton<_i37.JapaneseMannerRepository>(() =>
      _i38.JapaneseMannerRepositoryImpl(
          remoteDataSource: get<_i8.JapaneseMannersRemoteDataSource>()));
  gh.factory<_i39.LocationViaPostalCodeBloc>(() =>
      _i39.LocationViaPostalCodeBloc(
          getPrefectureCityFromPostalCode:
              get<_i31.GetPrefectureCityFromPostalCode>()));
  gh.lazySingleton<_i40.LogoutUser>(
      () => _i40.LogoutUser(repository: get<_i24.AuthRepository>()));
  gh.lazySingleton<_i41.NewsLocalDataSourceProtocol>(() =>
      _i41.NewsLocalDataSource(localProvider: get<_i42.NewsLocalProvider>()));
  ...
  gh.lazySingleton<_i49.ResumeRemoteDataSource>(() =>
      _i49.ResumeRemoteDataSourceImpl(
          client: get<_i3.Client>(),
          config: get<_i9.ConfigReader>(),
          auth: get<_i22.AuthLocalDataSource>()));
  gh.lazySingleton<_i50.ResumeRepository>(() => _i51.ResumeRepositoryImpl(
      dataSource: get<_i49.ResumeRemoteDataSource>()));
  gh.lazySingleton<_i52.SignInWithApple>(() => _i52.SignInWithApple(
      repository: get<_i24.AuthRepository>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.lazySingleton<_i53.SignInWithEmailAndPassword>(() =>
      _i53.SignInWithEmailAndPassword(
          repository: get<_i24.AuthRepository>(),
          networkInfo: get<_i13.NetworkInfo>()));
  gh.lazySingleton<_i54.SignInWithFacebook>(() => _i54.SignInWithFacebook(
      repository: get<_i24.AuthRepository>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.lazySingleton<_i55.SignInWithGoogle>(() => _i55.SignInWithGoogle(
      repository: get<_i24.AuthRepository>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.lazySingleton<_i56.SignUpWithEmailPasswordAndUserDetail>(() =>
      _i56.SignUpWithEmailPasswordAndUserDetail(
          repository: get<_i24.AuthRepository>(),
          networkInfo: get<_i13.NetworkInfo>()));
  gh.factory<_i57.SplashBloc>(
      () => _i57.SplashBloc(getWalletUser: get<_i33.GetWalletUser>()));
  gh.factory<_i58.UpdateAcadamicInfo>(() => _i58.UpdateAcadamicInfo(
      repository: get<_i50.ResumeRepository>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.factory<_i59.UpdateAddressInfo>(() => _i59.UpdateAddressInfo(
      repository: get<_i50.ResumeRepository>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.factory<_i60.UpdateOtherInfo>(() => _i60.UpdateOtherInfo(
      repository: get<_i50.ResumeRepository>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.factory<_i61.UpdatePersonalInfo>(() => _i61.UpdatePersonalInfo(
      repository: get<_i50.ResumeRepository>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.factory<_i62.UpdateQualificationInfo>(() => _i62.UpdateQualificationInfo(
      repository: get<_i50.ResumeRepository>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.factory<_i63.UpdateResumeImage>(() => _i63.UpdateResumeImage(
      repository: get<_i50.ResumeRepository>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.factory<_i64.UpdateWorkInfo>(() => _i64.UpdateWorkInfo(
      repository: get<_i50.ResumeRepository>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.lazySingleton<_i65.VerifyEmail>(() => _i65.VerifyEmail(
      repository: get<_i24.AuthRepository>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.factory<_i66.VerifyEmailBloc>(
      () => _i66.VerifyEmailBloc(verifyEmail: get<_i65.VerifyEmail>()));
  gh.factory<_i67.GetDownloadablePdfLink>(() => _i67.GetDownloadablePdfLink(
      repository: get<_i50.ResumeRepository>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.lazySingleton<_i68.GetFavouriteNews>(() =>
      _i68.GetFavouriteNews(repository: get<_i43.NewsRepositoryProtocol>()));
  gh.lazySingleton<_i69.GetHomePageData>(
      () => _i69.GetHomePageData(repository: get<_i35.HomeReporisitory>()));
  gh.lazySingleton<_i70.GetLatestNews>(() => _i70.GetLatestNews(
      repository: get<_i43.NewsRepositoryProtocol>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.lazySingleton<_i71.GetNewsForYou>(() => _i71.GetNewsForYou(
      repository: get<_i43.NewsRepositoryProtocol>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.lazySingleton<_i72.GetNewsGenre>(
      () => _i72.GetNewsGenre(repository: get<_i43.NewsRepositoryProtocol>()));
  gh.lazySingleton<_i73.GetNewsPreferences>(() =>
      _i73.GetNewsPreferences(repository: get<_i43.NewsRepositoryProtocol>()));
  gh.factory<_i74.GetResume>(() => _i74.GetResume(
      repository: get<_i50.ResumeRepository>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.lazySingleton<_i75.HomePageDataBloc>(() =>
      _i75.HomePageDataBloc(getHomePageData: get<_i69.GetHomePageData>()));
  gh.factory<_i76.JapaneseMannerBloc>(() => _i76.JapaneseMannerBloc(
      getJapaneseManner: get<_i77.GetJapaneseManner>()));
  gh.factory<_i78.JapaneseMannerCategoriesBloc>(() =>
      _i78.JapaneseMannerCategoriesBloc(
          getJapaneseMannerCategories:
              get<_i79.GetJapaneseMannerCategories>()));
  gh.factory<_i80.LatestNewsBloc>(
      () => _i80.LatestNewsBloc(getNews: get<_i70.GetLatestNews>()));
  gh.factory<_i81.NewsBloc>(
      () => _i81.NewsBloc(getNews: get<_i71.GetNewsForYou>()));
  gh.factory<_i82.NewsGenreBloc>(
      () => _i82.NewsGenreBloc(getNewsGenre: get<_i72.GetNewsGenre>()));
  gh.factory<_i83.NewsPreferenceBloc>(() => _i83.NewsPreferenceBloc(
      getNewsPreferences: get<_i73.GetNewsPreferences>()));
  gh.lazySingleton<_i84.ResumeWatcherBloc>(
      () => _i84.ResumeWatcherBloc(getResume: get<_i74.GetResume>()));
  gh.factory<_i85.SignInFormBloc>(() => _i85.SignInFormBloc(
      signInWithEmailUsecase: get<_i53.SignInWithEmailAndPassword>(),
      signInWithApple: get<_i52.SignInWithApple>(),
      signInWithFacebook: get<_i54.SignInWithFacebook>(),
      signInWithGoogle: get<_i55.SignInWithGoogle>()));
  gh.factory<_i86.SignUpFormBloc>(() => _i86.SignUpFormBloc(
      signUpWithEmailUsecase:
          get<_i56.SignUpWithEmailPasswordAndUserDetail>()));
  gh.factory<_i87.DownloadPdfBloc>(() => _i87.DownloadPdfBloc(
      getDownloadablePdfLink: get<_i67.GetDownloadablePdfLink>()));
  gh.factory<_i88.FavouriteNewsBloc>(() =>
      _i88.FavouriteNewsBloc(getFavouriteNews: get<_i68.GetFavouriteNews>()));
  gh.singleton<_i9.ConfigReader>(_i9.ConfigReaderImpl());
  gh.singleton<_i89.DBProvider>(_i89.DBProviderImpl());
  gh.singleton<_i42.NewsLocalProvider>(
      _i42.NewsLocalProviderImpl(provider: get<_i89.DBProvider>()));
  ...
  gh.singleton<_i48.GetPartnerServicesCategories>(
      _i48.GetPartnerServicesCategories(
          repository: get<_i16.PartnerServicesRepository>(),
          networkInfo: get<_i13.NetworkInfo>()));
  gh.singleton<_i77.GetJapaneseManner>(_i77.GetJapaneseManner(
      repository: get<_i37.JapaneseMannerRepository>(),
      networkInfo: get<_i13.NetworkInfo>()));
  gh.singleton<_i79.GetJapaneseMannerCategories>(
      _i79.GetJapaneseMannerCategories(
          repository: get<_i37.JapaneseMannerRepository>(),
          networkInfo: get<_i13.NetworkInfo>()));
  return get;
}

class _$HttpClientInjectableModule extends _i90.HttpClientInjectableModule {}

class _$DataConnectionCheckerModule extends _i91.DataConnectionCheckerModule {}

class _$FlutterStorageModule extends _i92.FlutterStorageModule {}

class _$GoogleLoginInjectableModule extends _i93.GoogleLoginInjectableModule {}

class _$SharedPreferenceModule extends _i94.SharedPreferenceModule {}
