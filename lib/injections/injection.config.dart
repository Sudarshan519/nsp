...
import '../core/database/local_database_provider.dart' as _i182;
...
import '../features/ads/presentation/get_ads/ads_bloc.dart' as _i169;
...
import '../features/auth/presentation/sign_in_form/sign_in_form_bloc.dart'
    as _i162;
import '../features/auth/presentation/sign_up/sign_up_form_bloc.dart' as _i163;
...
import '../features/home/domain/usecases/get_home_page_data.dart' as _i126;
...
import '../features/news/domain/usecase/get_favourite_news.dart' as _i125;
import '../features/news/domain/usecase/get_latest_news.dart' as _i128;
import '../features/news/domain/usecase/get_news_for_you.dart' as _i131;
import '../features/news/domain/usecase/get_news_genre.dart' as _i132;
import '../features/news/domain/usecase/get_news_preferences.dart' as _i133;
...
import '../features/news/presentation/latest_news/latest_news_bloc.dart'
    as _i144;
import '../features/news/presentation/news_for_you/news_bloc.dart' as _i146;
import '../features/news/presentation/news_genre/news_genre_bloc.dart' as _i147;
...
import '../features/resume/domain/usecases/get_downloadable_pdf_link.dart'
    as _i124;
import '../features/resume/domain/usecases/get_resume.dart' as _i136;
...
import '../features/search/domain/usecases/get_search_page_data.dart' as _i137;
import '../features/search/presentation/bloc/search_bloc.dart' as _i161;
...
import '../features/transaction/domain/usecase/get_individual_transaction.dart'
    as _i127;
import '../features/transaction/domain/usecase/get_transaction.dart' as _i139;
...
import 'injectable/data_connection_checker_injectable_module.dart' as _i186;
import 'injectable/flutter_secure_storage_module.dart' as _i184;
import 'injectable/google_login_injectable_module.dart' as _i185;
import 'injectable/http_client_injectable_module.dart' as _i183;
import 'injectable/shared_preference_module.dart'
    as _i187; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i124.GetDownloadablePdfLink>(() => _i124.GetDownloadablePdfLink(
      repository: get<_i71.ResumeRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i125.GetFavouriteNews>(() =>
      _i125.GetFavouriteNews(repository: get<_i60.NewsRepositoryProtocol>()));
  gh.lazySingleton<_i126.GetHomePageData>(() => _i126.GetHomePageData(
      repository: get<_i48.HomeReporisitory>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i127.GetIndivisualTransaction>(() =>
      _i127.GetIndivisualTransaction(
          repository: get<_i88.TransactionRepository>(),
          networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i128.GetLatestNews>(() => _i128.GetLatestNews(
      repository: get<_i60.NewsRepositoryProtocol>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i129.GetListOfCityFromPrefectures>(() =>
      _i129.GetListOfCityFromPrefectures(
          repository: get<_i55.LocationInformationRepositoryProtocol>()));
  gh.lazySingleton<_i130.GetListOfPaymentMethods>(() =>
      _i130.GetListOfPaymentMethods(
          networkInfo: get<_i14.NetworkInfo>(),
          repository: get<_i52.LoadBalanceRepositories>()));
  gh.lazySingleton<_i131.GetNewsForYou>(() => _i131.GetNewsForYou(
      repository: get<_i60.NewsRepositoryProtocol>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i132.GetNewsGenre>(
      () => _i132.GetNewsGenre(repository: get<_i60.NewsRepositoryProtocol>()));
  gh.lazySingleton<_i133.GetNewsPreferences>(() =>
      _i133.GetNewsPreferences(repository: get<_i60.NewsRepositoryProtocol>()));
  gh.factory<_i134.GetPaymentMethodsBloc>(() => _i134.GetPaymentMethodsBloc(
      getListOfPaymentMethods: get<_i130.GetListOfPaymentMethods>(),
      deletecard: get<_i117.DeleteCard>()));
  gh.lazySingleton<_i135.GetPrefectureCityFromPostalCode>(() =>
      _i135.GetPrefectureCityFromPostalCode(
          repository: get<_i55.LocationInformationRepositoryProtocol>()));
  gh.factory<_i136.GetResume>(() => _i136.GetResume(
      repository: get<_i71.ResumeRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i137.GetSearchPageData>(() => _i137.GetSearchPageData(
      repository: get<_i75.SearchRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i138.GetSubscriptionDetailForPartnerService>(() =>
      _i138.GetSubscriptionDetailForPartnerService(
          networkInfo: get<_i14.NetworkInfo>(),
          repository: get<_i99.UtilityPaymentRepository>()));
  gh.lazySingleton<_i139.GetTransactions>(() => _i139.GetTransactions(
      repository: get<_i88.TransactionRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i140.HomePageDataBloc>(() =>
      _i140.HomePageDataBloc(getHomePageData: get<_i126.GetHomePageData>()));
  gh.factory<_i141.IndividualTransactionBloc>(() =>
      _i141.IndividualTransactionBloc(
          getIndividualTxn: get<_i127.GetIndivisualTransaction>()));
  gh.lazySingleton<_i142.JapaneseMannerRepository>(() =>
      _i143.JapaneseMannerRepositoryImpl(
          remoteDataSource: get<_i50.JapaneseMannersRemoteDataSource>(),
          logger: get<_i12.Logger>()));
  gh.lazySingleton<_i144.LatestNewsBloc>(
      () => _i144.LatestNewsBloc(getNews: get<_i128.GetLatestNews>()));
  gh.factory<_i145.LocationViaPostalCodeBloc>(() =>
      _i145.LocationViaPostalCodeBloc(
          getPrefectureCityFromPostalCode:
              get<_i135.GetPrefectureCityFromPostalCode>()));
  gh.lazySingleton<_i146.NewsBloc>(
      () => _i146.NewsBloc(getNews: get<_i131.GetNewsForYou>()));
  gh.factory<_i147.NewsGenreBloc>(
      () => _i147.NewsGenreBloc(getNewsGenre: get<_i132.GetNewsGenre>()));
  gh.factory<_i148.NewsPreferenceBloc>(() => _i148.NewsPreferenceBloc(
      getNewsPreferences: get<_i133.GetNewsPreferences>()));
  gh.lazySingleton<_i149.NotificationRepository>(() =>
      _i150.NotificationRepositoryImpl(
          dataSource: get<_i62.NotificationsRemoteDataSource>(),
          logger: get<_i12.Logger>()));
  gh.factory<_i151.ParnterServicesBloc>(() => _i151.ParnterServicesBloc(
      getPartnerServices: get<_i152.GetPartnerServices>()));
  gh.factory<_i153.PartnerServiceCategoriesBloc>(() =>
      _i153.PartnerServiceCategoriesBloc(
          getPartnerServicesCategories:
              get<_i154.GetPartnerServicesCategories>()));
  gh.factory<_i155.PasswordResetBloc>(() => _i155.PasswordResetBloc(
      resetPasswordUseCase: get<_i69.ResetPasswordUseCase>()));
  gh.lazySingleton<_i156.PurchaseSubscriptionFromPartnerService>(() =>
      _i156.PurchaseSubscriptionFromPartnerService(
          networkInfo: get<_i14.NetworkInfo>(),
          repository: get<_i99.UtilityPaymentRepository>()));
  gh.factory<_i157.RedeemCouponBloc>(() => _i157.RedeemCouponBloc(
      applyCoupon: get<_i116.ApplyCoupon>(),
      redeemCoupon: get<_i68.RedeemCoupon>()));
  gh.lazySingleton<_i158.ResumeWatcherBloc>(() => _i158.ResumeWatcherBloc(
      getResume: get<_i136.GetResume>(),
      deleteResumeData: get<_i119.DeleteResumeData>()));
  gh.lazySingleton<_i159.RewardPointRepository>(() =>
      _i160.RewardPointRepositoryImpl(
          dataSource: get<_i73.RewardPointsRemoteDataSource>(),
          logger: get<_i12.Logger>()));
  gh.factory<_i161.SearchBloc>(
      () => _i161.SearchBloc(get<_i137.GetSearchPageData>()));
  gh.factory<_i162.SignInFormBloc>(() => _i162.SignInFormBloc(
  ...
  gh.factory<_i163.SignUpFormBloc>(() => _i163.SignUpFormBloc(
      signUpWithEmailUsecase:
          get<_i81.SignUpWithEmailPasswordAndUserDetail>()));
  gh.factory<_i164.SubscriptionForPartnerServiceBloc>(() =>
      _i164.SubscriptionForPartnerServiceBloc(
          getSubscriptionDetailForPartnerService:
              get<_i138.GetSubscriptionDetailForPartnerService>(),
          purchaseSubscriptionFromPartnerService:
              get<_i156.PurchaseSubscriptionFromPartnerService>()));
  gh.lazySingleton<_i165.TopUpBalanceForMobile>(() =>
      _i165.TopUpBalanceForMobile(
          networkInfo: get<_i14.NetworkInfo>(),
          repository: get<_i99.UtilityPaymentRepository>()));
  gh.factory<_i166.TopUpBalanceInMobileBloc>(() =>
      _i166.TopUpBalanceInMobileBloc(
          topUpBalanceForMobile: get<_i165.TopUpBalanceForMobile>()));
  gh.lazySingleton<_i167.TransactionBloc>(() =>
      _i167.TransactionBloc(getTransaction: get<_i139.GetTransactions>()));
  gh.factory<_i168.UpdateProfileBloc>(() => _i168.UpdateProfileBloc(
      updateKycInfo: get<_i92.UpdateKycInfo>(),
      updateResumeImage: get<_i96.UpdateResumeImage>(),
      getListOfCityFromPrefectures: get<_i129.GetListOfCityFromPrefectures>()));
  gh.factory<_i169.AdsBloc>(() =>
      _i169.AdsBloc(get<_i120.GetAds>(), get<_i113.AdsRemoteDataSource>()));
  gh.factory<_i170.DownloadPdfBloc>(() => _i170.DownloadPdfBloc(
      getDownloadablePdfLink: get<_i124.GetDownloadablePdfLink>()));
  gh.factory<_i171.FavouriteNewsBloc>(() =>
      _i171.FavouriteNewsBloc(getFavouriteNews: get<_i125.GetFavouriteNews>()));
  gh.lazySingleton<_i172.GetNotifications>(() => _i172.GetNotifications(
      repository: get<_i149.NotificationRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i173.GetRewardPoints>(() => _i173.GetRewardPoints(
      repository: get<_i159.RewardPointRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.factory<_i174.JapaneseMannerBloc>(() => _i174.JapaneseMannerBloc(
      getJapaneseManner: get<_i175.GetJapaneseManner>()));
  gh.factory<_i176.JapaneseMannerCategoriesBloc>(() =>
      _i176.JapaneseMannerCategoriesBloc(
          getJapaneseMannerCategories:
              get<_i177.GetJapaneseMannerCategories>()));
  gh.factory<_i178.JapaneseMannerDetailBloc>(() =>
      _i178.JapaneseMannerDetailBloc(
          getJpMannerDetail: get<_i179.GetJapaneseMannerDetail>()));
  gh.factory<_i180.NotificationsBloc>(() =>
      _i180.NotificationsBloc(getNotifications: get<_i172.GetNotifications>()));
  gh.factory<_i181.RewardPointBloc>(() =>
      _i181.RewardPointBloc(getRewardPoints: get<_i173.GetRewardPoints>()));
  gh.singleton<_i13.ConfigReader>(_i13.ConfigReaderImpl());
  gh.singleton<_i182.DBProvider>(_i182.DBProviderImpl());
  gh.singleton<_i59.NewsLocalProvider>(
      _i59.NewsLocalProviderImpl(provider: get<_i182.DBProvider>()));
  gh.singleton<_i67.PurchasePackage>(_i67.PurchasePackage(
      repository: get<_i64.PartnerServicesRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i152.GetPartnerServices>(_i152.GetPartnerServices(
      repository: get<_i64.PartnerServicesRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i154.GetPartnerServicesCategories>(
      _i154.GetPartnerServicesCategories(
          repository: get<_i64.PartnerServicesRepository>(),
          networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i175.GetJapaneseManner>(_i175.GetJapaneseManner(
      repository: get<_i142.JapaneseMannerRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i177.GetJapaneseMannerCategories>(
      _i177.GetJapaneseMannerCategories(
          repository: get<_i142.JapaneseMannerRepository>(),
          networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i179.GetJapaneseMannerDetail>(_i179.GetJapaneseMannerDetail(
      repository: get<_i142.JapaneseMannerRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  return get;
}

class _$HttpClientInjectableModule extends _i183.HttpClientInjectableModule {}

class _$FlutterStorageModule extends _i184.FlutterStorageModule {}

class _$GoogleLoginInjectableModule extends _i185.GoogleLoginInjectableModule {}

class _$DataConnectionCheckerModule extends _i186.DataConnectionCheckerModule {}

class _$SharedPreferenceModule extends _i187.SharedPreferenceModule {}
