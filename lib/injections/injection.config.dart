...
import '../core/database/local_database_provider.dart' as _i173;
...
import '../features/ads/presentation/get_ads/ads_bloc.dart' as _i160;
...
import '../features/auth/presentation/sign_in_form/sign_in_form_bloc.dart'
    as _i153;
import '../features/auth/presentation/sign_up/sign_up_form_bloc.dart' as _i154;
...
import '../features/search/presentation/bloc/search_bloc.dart' as _i152;
...
import 'injectable/data_connection_checker_injectable_module.dart' as _i177;
import 'injectable/flutter_secure_storage_module.dart' as _i175;
import 'injectable/google_login_injectable_module.dart' as _i176;
import 'injectable/http_client_injectable_module.dart' as _i174;
import 'injectable/shared_preference_module.dart'
    as _i178; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i68.ResumeRepository>(() => _i69.ResumeRepositoryImpl(
      ...
      logger: get<_i12.Logger>()));
  gh.lazySingleton<_i70.RewardPointsRemoteDataSource>(() =>
      _i70.RewardPointsRemoteDataSourceImpl(
          client: get<_i3.Client>(),
          config: get<_i13.ConfigReader>(),
          auth: get<_i21.AuthLocalDataSource>(),
          logger: get<_i12.Logger>()));
  ...
  gh.factory<_i79.SplashBloc>(
      () => _i79.SplashBloc(getWalletUser: get<_i41.GetWalletUser>()));
  ...
  gh.lazySingleton<_i116.GetFavouriteNews>(() =>
      _i116.GetFavouriteNews(repository: get<_i57.NewsRepositoryProtocol>()));
  ...
  gh.lazySingleton<_i123.GetNewsGenre>(
      () => _i123.GetNewsGenre(repository: get<_i57.NewsRepositoryProtocol>()));
  gh.lazySingleton<_i124.GetNewsPreferences>(() =>
      _i124.GetNewsPreferences(repository: get<_i57.NewsRepositoryProtocol>()));
  ...
  gh.lazySingleton<_i150.RewardPointRepository>(() =>
      _i151.RewardPointRepositoryImpl(
          dataSource: get<_i70.RewardPointsRemoteDataSource>(),
          logger: get<_i12.Logger>()));
  gh.factory<_i152.SearchBloc>(
      () => _i152.SearchBloc(get<_i128.GetSearchPageData>()));
  gh.factory<_i153.SignInFormBloc>(() => _i153.SignInFormBloc(
  ...
  gh.factory<_i154.SignUpFormBloc>(() => _i154.SignUpFormBloc(
      signUpWithEmailUsecase:
          get<_i78.SignUpWithEmailPasswordAndUserDetail>()));
  gh.factory<_i155.SubscriptionForPartnerServiceBloc>(() =>
      _i155.SubscriptionForPartnerServiceBloc(
  ...
  gh.lazySingleton<_i156.TopUpBalanceForMobile>(() =>
      _i156.TopUpBalanceForMobile(
          networkInfo: get<_i14.NetworkInfo>(),
          repository: get<_i94.UtilityPaymentRepository>()));
  gh.factory<_i157.TopUpBalanceInMobileBloc>(() =>
      _i157.TopUpBalanceInMobileBloc(
          topUpBalanceForMobile: get<_i156.TopUpBalanceForMobile>()));
  gh.lazySingleton<_i158.TransactionBloc>(() =>
      _i158.TransactionBloc(getTransaction: get<_i130.GetTransactions>()));
  gh.factory<_i159.UpdateProfileBloc>(() => _i159.UpdateProfileBloc(
  ...
  gh.factory<_i160.AdsBloc>(() =>
      _i160.AdsBloc(get<_i113.GetAds>(), get<_i106.AdsRemoteDataSource>()));
  gh.factory<_i161.DownloadPdfBloc>(() => _i161.DownloadPdfBloc(
      getDownloadablePdfLink: get<_i115.GetDownloadablePdfLink>()));
  gh.factory<_i162.FavouriteNewsBloc>(() =>
      _i162.FavouriteNewsBloc(getFavouriteNews: get<_i116.GetFavouriteNews>()));
  gh.lazySingleton<_i163.GetNotifications>(() => _i163.GetNotifications(
      repository: get<_i140.NotificationRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.lazySingleton<_i164.GetRewardPoints>(() => _i164.GetRewardPoints(
      repository: get<_i150.RewardPointRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.factory<_i165.JapaneseMannerBloc>(() => _i165.JapaneseMannerBloc(
      getJapaneseManner: get<_i166.GetJapaneseManner>()));
  gh.factory<_i167.JapaneseMannerCategoriesBloc>(() =>
      _i167.JapaneseMannerCategoriesBloc(
          getJapaneseMannerCategories:
              get<_i168.GetJapaneseMannerCategories>()));
  gh.factory<_i169.JapaneseMannerDetailBloc>(() =>
      _i169.JapaneseMannerDetailBloc(
          getJpMannerDetail: get<_i170.GetJapaneseMannerDetail>()));
  gh.factory<_i171.NotificationsBloc>(() =>
      _i171.NotificationsBloc(getNotifications: get<_i163.GetNotifications>()));
  gh.factory<_i172.RewardPointBloc>(() =>
      _i172.RewardPointBloc(getRewardPoints: get<_i164.GetRewardPoints>()));
  gh.singleton<_i13.ConfigReader>(_i13.ConfigReaderImpl());
  gh.singleton<_i173.DBProvider>(_i173.DBProviderImpl());
  gh.singleton<_i56.NewsLocalProvider>(
      _i56.NewsLocalProviderImpl(provider: get<_i173.DBProvider>()));
  ...
  gh.singleton<_i145.GetPartnerServicesCategories>(
      _i145.GetPartnerServicesCategories(
          repository: get<_i61.PartnerServicesRepository>(),
          networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i166.GetJapaneseManner>(_i166.GetJapaneseManner(
      repository: get<_i133.JapaneseMannerRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i168.GetJapaneseMannerCategories>(
      _i168.GetJapaneseMannerCategories(
          repository: get<_i133.JapaneseMannerRepository>(),
          networkInfo: get<_i14.NetworkInfo>()));
  gh.singleton<_i170.GetJapaneseMannerDetail>(_i170.GetJapaneseMannerDetail(
      repository: get<_i133.JapaneseMannerRepository>(),
      networkInfo: get<_i14.NetworkInfo>()));
  return get;
}

class _$HttpClientInjectableModule extends _i174.HttpClientInjectableModule {}

class _$FlutterStorageModule extends _i175.FlutterStorageModule {}

class _$GoogleLoginInjectableModule extends _i176.GoogleLoginInjectableModule {}

class _$DataConnectionCheckerModule extends _i177.DataConnectionCheckerModule {}

class _$SharedPreferenceModule extends _i178.SharedPreferenceModule {}
