...
abstract class NewsRepositoryProtocol {
  ...
  Future saveFavouriteNews({@required NewsItem item});

  Future<Either<ApiFailure, List<Genre>>> getGenreList();
  Future<Either<ApiFailure, List<NewsPreference>>> getPreferenceList();
  Future saveGenreList({@required List<Genre> genre});
  Future saveNewsPreferences({@required List<NewsPreference> preference});
}
