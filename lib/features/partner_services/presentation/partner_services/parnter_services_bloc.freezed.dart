...
mixin _$ParnterServicesEvent {
  ...
  TResult when<TResult extends Object>({
    @required TResult fetch(ServicesCategory category),
    @required TResult pullToRefresh(ServicesCategory category),
  });
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object>({
    TResult fetch(ServicesCategory category),
    TResult pullToRefresh(ServicesCategory category),
...
class _$ParnterServicesEventCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      category:
          category == freezed ? _value.category : category as ServicesCategory,
    ));
  }
}
...
class _$_PullToRefresh implements _PullToRefresh {
  const _$_PullToRefresh(this.category) : assert(category != null);
