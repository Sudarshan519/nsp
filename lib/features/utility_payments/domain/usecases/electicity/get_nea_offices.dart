...
@lazySingleton
class GetNeaOffice implements Usecase<ApiFailure, List<NEAOffice>, NoParams> {
  ...
  @override
  Future<Either<ApiFailure, List<NEAOffice>>> call(NoParams params) async {
    ...
    return repository.getNEAOffices();
  }
}
