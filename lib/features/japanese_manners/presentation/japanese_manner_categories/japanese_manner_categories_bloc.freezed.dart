...
/// @nodoc
abstract class $JapaneseMannerCategoriesEventCopyWith<$Res> {
...
class _$_Fetch implements _Fetch {
  ...
  @override
  String toString() {
    return 'JapaneseMannerCategoriesEvent.fetch()';
  }
...
abstract class _Fetch implements JapaneseMannerCategoriesEvent {
...
mixin _$JapaneseMannerCategoriesState {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult loaded(List<JapaneseMannerCategory> categories),
  ...
  TResult maybeWhen<TResult extends Object>({
    TResult initial(),
    TResult loading(),
    TResult loaded(List<JapaneseMannerCategory> categories),
...
/// @nodoc
abstract class $JapaneseMannerCategoriesStateCopyWith<$Res> {
...
class _$_Initial implements _Initial {
  ...
  @override
  String toString() {
    return 'JapaneseMannerCategoriesState.initial()';
  }
...
abstract class _Initial implements JapaneseMannerCategoriesState {
...
class _$_Loading implements _Loading {
  ...
  @override
  String toString() {
    return 'JapaneseMannerCategoriesState.loading()';
  }
...
abstract class _Loading implements JapaneseMannerCategoriesState {
...
class __$LoadedCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_Loaded(
      categories == freezed
          ? _value.categories
          : categories as List<JapaneseMannerCategory>,
    ));
  }
}
...
class _$_Loaded implements _Loaded {
  ...
  @override
  String toString() {
    return 'JapaneseMannerCategoriesState.loaded(categories: $categories)';
  }
...
class _$_Failure implements _Failure {
  ...
  @override
  String toString() {
    return 'JapaneseMannerCategoriesState.failure(failure: $failure)';
  }
